...
command = sprintf('cp Start.dat %s\\%s',char(keypath2),foldername);
...
[elem,nbe,nelem,nodelim,intnode,flaglim] = getelem(verifymshfile,nnode,numwell,...
    well);
