...
% mpfad     --> (MPFA-D)
% lfvLPEW   --> metodo linear basedo no método não linear usando LPEW (MPFA-HD), ter cuidado linha 52 e 54 do preNLFV
% lfvHP     --> (MPFA-H)
% lfvEB     --> metodo completamente baseado na face (MPFA-BE), ainda os
% testes nao foram feitos
% nlfvLPEW  --> (NLFV-PP)
% nlfvDMPSY --> metodo não linear que preserva DMP baseado no artigo (Gao e Wu, 2013) e (Sheng e Yuan, 20...)
...
mobility(:)=1;
%% Solver: Calculo da pressao pelos método lineares e nao-lineares
