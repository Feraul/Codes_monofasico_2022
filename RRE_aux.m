...
% --- Repeated RRE iteration --- %

% Arnoldi saves the r values
m = 30;
p = 0.1;
delta = Inf;
epsilon = 0.00000001;
...
while delta > epsilon
    ...
    r = r_new;
    % 1 iteration of the power method
    y = (1-p)*(A*r);
    % norm(r,1) should be 1
    % using norm(r,1) will lead to an instable calculation... norm(r,1) will
...
csvwrite('RRE Iteration_PageRank.dat', r);
function [ v ] = RRE(A, r, e, p, maxit)
n = max(size(e));
R = zeros(n,maxit);
